 ...
 * @generated
 */
public class CM_DSLSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CM_DSLPackage.CM: {
				CM cm = (CM)theEObject;
				T result = caseCM(cm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CM_DSLPackage.CONFIGURATION: {
				Configuration configuration = (Configuration)theEObject;
				T result = caseConfiguration(configuration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CM_DSLPackage.INFRASTRUCTURE: {
				Infrastructure infrastructure = (Infrastructure)theEObject;
				T result = caseInfrastructure(infrastructure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CM_DSLPackage.APPLICATION: {
				Application application = (Application)theEObject;
				T result = caseApplication(application);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CM_DSLPackage.OPTIMISATION_ALGO: {
				OptimisationAlgo optimisationAlgo = (OptimisationAlgo)theEObject;
				T result = caseOptimisationAlgo(optimisationAlgo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CM_DSLPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CM_DSLPackage.COMMUNICATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Optimisation Algo</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Optimisation Algo</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOptimisationAlgo(OptimisationAlgo object) {
		return null;
	}
