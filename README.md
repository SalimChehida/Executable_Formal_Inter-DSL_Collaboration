...
https://prob.hhu.de/w/index.php?title=Download
  - We note there are several failures with ProB when running it on MacOS (an Arm processor), which can prevent the execution of the final animation and verification step (Section 4).
